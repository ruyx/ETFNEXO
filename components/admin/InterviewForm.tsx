...
import { Save, X, Eye, Youtube, Plus, Trash2, HelpCircle, Upload, Search, Loader2, Image as ImageIcon, Building2 } from 'lucide-react';
    ...
    <form onSubmit={(e) => handleSubmit(e, false)} className="admin-form admin-form--grid">
      ...
      <div className="admin-form-main">
          ...
          <div className="admin-form-section--compact">
            ...
            <p className="admin-form-help" style={{ marginBottom: 'var(--spacing-4)' }}>
              Agrega información de los patrocinadores que se mostrarán en la entrevista.
            </p>
            ...
            {sponsors.length === 0 ? (
              <div className="article-form-faq-empty">
                ...
                <p className="admin-form-help">
                  Agrega patrocinadores para mostrar información en la entrevista
                </p>
              </div>
            ) : (
              <div className="article-form-faq-list">
